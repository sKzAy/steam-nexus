  ...
  const data = [
    {
      ...
      content: (
        <div className="">
            <p className="time-p cap2 mt-16 text-2xl">First day starts at <span className="text-yellow-500">8:00 AM</span></p>
      ...
      },
    {
      ...
      content: (
        <div className="">
            <p className="time-p cap2 mt-16 text-2xl">Second day starts at <span className="text-yellow-500">8:00 AM</span></p>
            <p className=" cap2 pt-2 text-2xl"> Check in <span className="text-yellow-500">8:00 - 8:30 AM</span></p>
