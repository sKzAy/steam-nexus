    ...
    return (
        <>
            <div id='registration' className="about-event flex1 mt-10 ">
                <div className=" mod-div text-white rounded-xl border-2 border-red-500 p-10"><h2 className='font-extrabold text-2xl text-yellow-500' id='modules'>Registration:</h2>
